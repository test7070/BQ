...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
			...
			q_tables = 's';
			var q_name = "vcc";
			var q_readonly = ['txtNoa', 'txtAccno', 'txtComp','txtCardeal','txtSales', 'txtAcomp', 'txtMoney', 'txtTax', 'txtTotal', 'txtWeight', 'txtWorker', 'txtWorker2','txtTranmoney'];
			var q_readonlys = ['txtTotal', 'txtOrdeno', 'txtNo2','txtNoq'];
			var bbmNum = [
				['txtPrice', 10, 3, 1], ['txtTranmoney', 11, 0, 1], ['txtMoney', 15, 0, 1], ['txtTax', 15, 0, 1],
				['txtTotal', 15, 0, 1],['txtFloata', 11, 5, 1]
			];
			var bbsNum = [];
			var bbmMask = [];
			var bbsMask = [];
			...
			aPop = new Array(
				['txtCustno', 'lblCust', 'cust', 'noa,nick,tel,fax,zip_comp,addr_comp,paytype,trantype,salesno,sales', 'txtCustno,txtComp,txtTel,txtFax,txtPost,txtAddr,txtSalesno,txtSales', 'cust_b.aspx'],
			...
			function sum() {
				var t1 = 0, t_unit, t_mount, t_weight = 0,t_money=0,t_tax = 0, t_total = 0,total=1,tranmoney=0;
				for (var j = 0; j < q_bbsCount; j++) {
					t_unit = $('#txtUnit_' + j).val();
					t_mount = q_float('txtMount_' + j);
					t_weight+=q_float('txtWeight_' + j)*q_float('txtMount_' + j);
				...
				if($('#chkAtax').prop('checked')){
					...
					total=t_total*$('#txtFloata').val();
					tranmoney=$('#txtWeight').val()*$('#txtPrice').val();
				$('#txtMoney').val(FormatNumber(t_money));
				$('#txtWeight').val(FormatNumber(t_weight));	
				$('#txtTax').val(FormatNumber(t_tax));
				$('#txtTranmoney').val(FormatNumber(tranmoney));
				...
				//total = q_add(q_mul(addMoney),price);
				//q_tr('txtTranmoney', total);
				//q_tr('txtTotal', round(q_mul(q_float('txtTotal'), q_float('txtFloata')),2));
			}
			...
			function mainPost() {
				...
				q_mask(bbmMask);
				bbmNum = [	['txtPrice', 10, q_getPara('vcc.pricePrecision'), 1], ['txtTranmoney', 11, 0, 1], ['txtMoney', 15, 0, 1], ['txtTax', 15, 0, 1],['txtTotal', 15, 0, 1],['txtFloata', 11, 5, 1]];
				...
				$('#btn2accc').click(function() {
					alert('abv');
					//t_where = "accc2='" + $('#txtDatea').val() + "' and carno='" + $('#txtCarno').val() + "' and driverno='" + $('#txtDriverno').val() + "'";
					q_box("accc.aspx?" + r_userno + ";" + r_name + ";" + q_time + ";", 'accc', "95%", "95%", q_getMsg('btn2accc'));
				});
			}
		...
		<div id="dmain" style="width: 1260px;">
			...
			<div class='dbbm'>
				<table class="tbbm"  id="tbbm" style="width: 872px;">
					...
					<tr>
						<td class="td1"><span> </span><a class="lbl">送貨地址</a></td>
						<td class="td2"><input id="txtPost" type="text" class="txt c1"/></td>
						<td class="td3" colspan='4'><input id="txtAddr" type="text" class="txt c1"/></td>
						<td class="td6"><span> </span><a id="lblStore" class="lbl"> </a></td>
						<td class="td7">
						<input id="txtStoreno" type="text" class="txt num c1" style="width: 49%;"/>
						<input id="txtStore" type="text" class="txt num c1" style="width: 49%;"/>
						</td>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="td4"><input id="txtCarno"  type="text" class="txt" style="width:75%;"/></td>
		...
		<div class='dbbs' style="width: 1400px;">
			<table id="tbbs" class='tbbs'>
				<tr style='color:White; background:#003366;' >
					...
					<td align="center" style="width:120px;">訂單號碼</td>
					<td align="center" style="width:100px;">訂序</td>
				...
				<tr style='background:#cad3ff;'>
					...
					<td><input id="txtOrdeno.*" type="text" class="txt num c1"/></td>
