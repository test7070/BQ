	...
	<head>
		...
		<script type="text/javascript">
			...
			function mainPost() {
				...
				bbsNum = [['txtGweight', 10, 2, 1],['txtMount', 10, 2, 1], ['txtPrice', 10, 2, 1], ['txtTotal', 15, 0, 1]];
				
				window.parent.document.title='詢價單';
			...
			function _btnSeek() {
				...
				q_box('ordex_bq_s.aspx', q_name + '_s', "500px", "310px", q_getMsg("popSeek"));
			}
			function bbsAssign() {
				for (var j = 0; j < q_bbsCount; j++) {
			...
			function btnPrint() {
					q_box('z_ordexp_bq.aspx' + "?;;;noa=" + trim($('#txtNoa').val()) + ";" + r_accy, '', "95%", "95%", m_print);
			}
		...
		<div class='dbbs' style="width: 1260px;">
			<table id="tbbs" class='tbbs' border="1" cellpadding='2' cellspacing='1' >
				<tr style='color:White; background:#003366;' >
					...
					<td align="center" style="width:120px;"><a id='lblStyle'>規格(mm)</a></td>
					<td align="center" style="width:70px;"><a id='lblGweight'>單重</a></td>
					<td align="center" style="width:40px;"><a id='lblUnit'> </a></td>
					<td align="center" style="width:70px;"><a id='lblMount'> </a></td>
					<td align="center" style="width:50px;"><a id='lblPrices'> </a></td>
					<td align="center" style="width:100px;"><a id='lblTotals'>複價</a></td>
					<td align="center" style="width:100px;"><a id='lblMemo'>備註</a></td>
				</tr>
				<tr style='background:#cad3ff;'>
					...
					<td align="center">
						...
						<input id="txtNo2.*" type="text" class="txt c6" />
					</td>
