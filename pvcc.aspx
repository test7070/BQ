		...
		<div id="dmain" style="width: 1260px;">
			...
			<div class='dbbm'>
				<table class="tbbm"  id="tbbm" style="width: 872px;">
					...
					<tr>
						<td class="td1"><span> </span><a id="lblcomp" class="lbl btn">公司</a></td>
		...
		<div class='dbbs' style="width: 1400px;">
			<table id="tbbs" class='tbbs'>
				<tr style='color:White; background:#003366;' >
					...
					<td align="center" style="width:180px" id='xbProductno'><a id='lblProductno'>產品編號</a></td>
					<td align="center" style="width:180px;" id='xbProduct'><a id='lblProduct_s'>產品名稱</a></td>
					<td align="center" style="width:95px;" class="isStyle"><a id='lblStyle_s'> </a></td>
					<td align="center" style="width:40px;"><a id='lblSpec_s'> </a></td>
					<td align="center" style="width:40px;"><a id='lblUnit_s'> </a></td>
					<td align="center" style="width:80px;"><a id='lblMount_s'> </a></td>
					<td align="center" style="width:60px;">製造商或代號</td>
					<td align="center" style="width:40px;">年份</td>
					<td align="center" style="width:100px;">製造編號</td>
					<td align="center" style="width:40px;">單重</td>
					<td align="center" style="width:100px;">單位許可差</td>
					<td align="center" style="width:100px;">實際重</td>
				...
				<tr style='background:#cad3ff;'>
					...
					<td><input id="txtodate.*" type="text" class="txt num c1"/></td>
					<td><input id="txtUno.*" type="text" class="txt num c1"/></td>
					<td><input id="txtWeight.*" type="text" class="txt num c1"/></td>
					<td><input id="txtAdjweight.*" type="text" class="txt num c1"/></td>
					<td><input id="txtEcount.*" type="text" class="txt num c1"/></td>
