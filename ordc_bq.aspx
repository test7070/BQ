    ...
    <head>
        ...
        <script type="text/javascript">
			...
			aPop = new Array(
				...
				['txtTggno', 'lblTgg', 'tgg', 'noa,comp,tel,fax', 'txtTggno,txtTgg,txtTel,txtFax', 'tgg_b.aspx'],
			...
			<div class='dbbm' >
				<table class="tbbm" id="tbbm" style="width: 872px;">
					...
					<tr>
						...
						<td style="width: 108px;"><input id="txtTax" type="text" class="txt num c1 lef" /></td>
						<td style="width: 108px;"><select id="cmbTaxtype" class="txt c1" onchange='sum()' > </select></td>
		...
		<div class='dbbs'>
            <table id="tbbs" class='tbbs' style=' text-align:center'>
                <tr style='color:white; background:#003366;' >
					...
					<td align="center" style="width:80px;"><a id='lblWeight_bq'>單重</a></td>
					...
					<td align="center" style="width:90px;"><a id='lblTrandate'>預定進貨日</a></td>
