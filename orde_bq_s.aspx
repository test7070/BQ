	...
	<head>
		...
		<script type="text/javascript">
            ...
            function q_gfPost() {
                ...
                bbmMask = [['txtBdate', r_picd], ['txtEdate', r_picd],['txtBdate1', r_picd], ['txtEdate1', r_picd]];
                q_mask(bbmMask);
            }
            ...
            function q_seekStr() {///  搜尋按下時，執行
                ...
                t_bdate1 = $('#txtBdate1').val();
                t_edate1 = $('#txtEdate1').val();
                ...
                var t_where = " 1=1 " + q_sqlPara2("odate", t_bdate, t_edate) + q_sqlPara2("date1", t_bdate1, t_edate1) + q_sqlPara2("noa", t_noa) + q_sqlPara2("comp", t_comp) + q_sqlPara2("custno", t_custno) + q_sqlPara2("contract", t_contract);
	...
	<body>
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
				...
				<tr class='seek_tr'>
                    <td   style="width:35%;" ><a id='lblDate1'>交貨日期</a></td>
                    <td style="width:65%;  ">
