	...
	<head>
		...
		<script type="text/javascript">
            ...
            function q_seekStr() {///  搜尋按下時，執行
                ...
                t_comp = $('#txtComp').val();
                t_quatno = $('#txtOrdcno').val();
                t_bdate = t_bdate.length > 0 && t_bdate.indexOf("_") > -1 ? t_bdate.substr(0, t_bdate.indexOf("_")) : t_bdate;
                /// 100.  .
                t_edate = t_edate.length > 0 && t_edate.indexOf("_") > -1 ? t_edate.substr(0, t_edate.indexOf("_")) : t_edate;
                /// 100.  .

                var t_where = " 1=1 " + q_sqlPara2("datea", t_bdate, t_edate) + q_sqlPara2("noa", t_noa) + q_sqlPara2("comp", t_comp) + q_sqlPara2("custno", t_custno) + q_sqlPara2("ordcno", t_quatno) ;
	...
	<body>
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
				<tr class='seek_tr'>
					<td   style="width:35%;" ><a id='lblDatea'>報價日期</a></td>
					<td style="width:65%;  ">
				...
				<tr class='seek_tr'>
					<td class='seek'  style="width:20%;"><a id='lblNoa'>詢價單號</a></td>
					<td><input class="txt" id="txtNoa" type="text" style="width:215px; font-size:medium;" /></td>
				</tr>
				<tr class='seek_tr'>
                    <td class='seek'  style="width:20%;"><a id='lblOrdcno'>合約號碼</a></td>
                    <td><input class="txt" id="txtOrdcno" type="text" style="width:215px; font-size:medium;" /></td>
                </tr>
			</table>
