...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
			...
			brwKey = 'datea';
			aPop = new Array(
				['txtTggno', 'lblTgg', 'tgg', 'noa,nick,tel,zip_invo,addr_comp,paytype', 'txtTggno,txtTgg,txtTel', 'tgg_b.aspx'],
				...
				['txtSales', 'lblSalesa', 'sss', 'noa,namea', 'txtSalesno,txtSales', 'sss_b.aspx'],
				...
				['txtProductno_', 'btnProductno_', 'ucaucc', 'noa,product,unit,spec', 'txtProductno_,txtProduct_,txtSpec_', 'ucaucc_b.aspx'],
			...
			function sum() {
				var t1 = 0, t_unit, t_mount=0, t_weight = 0,t_money=0, t_tax = 0, t_total = 0,weight=0,total=0;
				for (var j = 0; j < q_bbsCount; j++) {
					t_unit = $('#txtUnit_' + j).val();
					t_mount = q_float('txtMount_' + j);
					t_weight+= q_float('txtWeight_' + j);
					weight += q_float('txtMount_' + j)*q_float('txtWeight_' + j)
				...
				$('#txtWeight').val(FormatNumber(weight));
			...
			function mainPost() {
				...
				q_mask(bbmMask);
				bbmNum = [['txtMoney', 15, 5, 1, 1], ['txtTax', 15, 5, 1, 1], ['txtTotal', 15, 5, 1, 1], ['txtFloata', 15, 5, 1, 1]];
				bbsNum = [['txtMount', 15, q_getPara('rc2.mountPrecision'), 1, 1],['txtTotal', 15, 5, 1, 1]];
			...
			<div class='dbbm'>
				<table class="tbbm" id="tbbm" style="width: 872px;">
					<tr class="tr1">
						...
						<td class="td7"><span> </span><a id='lblSalesa' class="lbl btn">簽收員</a></td>
						<td class="td8">
						<input id="txtSalesno" type="text" class="txt c1" style="width: 39%;"/>
						<input id="txtSales" type="text" class="txt c1" style="width: 59%;"/>
						</td>
					</tr>
					<tr class="tr2">
					...
					<tr>
						...
						<td class="td4"><input id="txtWeight" type="text" class="txt c1" style="width: 49%;"/></td>
					</tr>
					<tr class="tr8">
		...
		<div class='dbbs' style="width: 1400px;">
			<table id="tbbs" class='tbbs' border="1" cellpadding='2' cellspacing='1' >
				<tr style='color:White; background:#003366;' >
					...
					<td align="center" style="width:40px;"><a id='lblWeighta'>單重</a></td>
