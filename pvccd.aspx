...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
			...
			q_tables = 's';
			var q_name = "workbq";
			var q_readonly = ['txtNoa', 'txtAccno', 'txtComp','txtCardeal','txtSales', 'txtAcomp', 'txtWorker', 'txtWorker2','txtTranstart','txtSpec'];
			...
			function mainPost() {
				...
				$('#btnOrdes').click(function() {
					var t_custno = trim($('#txtPartno').val());
					var t_ordeno = trim($('#txtOrdeno').val());
					alert('txtCustno=' + t_custno + ' txtOrdeno=' + t_ordeno)
					if (t_custno.length == 0)
						alert('客戶為空');
					q_func('qtxt.orde.open', 'orde_bq.txt,import1,' + t_custno+ ';' + t_ordeno);
				});
					...
					case 'ordes':
						if (q_cur > 0 && q_cur < 4) {
							...
							if (q_getPara('sys.project').toUpperCase()=='RB'){
								ret = q_gridAddRow(bbsHtm, 'tbbs', 'txtProductno,txtProduct,txtSpec,txtSize,txtDime,txtWidth,txtLengthb,txtUnit,txtOrdeno,txtNo2,txtMount,txtMemo', b_ret.length, b_ret, 'productno,product,spec,size,dime,width,lengthb,unit,noa,no2,price,notv,memo', 'txtProductno,txtProduct,txtSpec');
							}else{
								ret = q_gridAddRow(bbsHtm, 'tbbs', 
								'txtProductno,txtProduct,txtSpec,txtUnit,txtOrdeno,txtNo2,txtPrice,txtMount,txtWeight,txtMemo'
								,b_ret.length, b_ret
								,'productno,product,spec,unit,noa,no2,price,mount,weight,memo', 'txtProductno,txtProduct,txtSpec');
							}
							//寫入訂單號碼
							var t_oredeno = '';
		...
		<div id="dmain" style="width: 1260px;">
			...
			<div class='dbbm'>
				<table class="tbbm"  id="tbbm" style="width: 872px;">
					<tr>
						<td class="td1" style="width: 108px;"><span> </span><a class="lbl">檢驗日期</a></td>
						...
						<td class="td5" style="width: 108px;"><span> </span><a id='lblOrdeno' class="lbl">訂單號碼</a></td>
						<td class="td6" style="width: 108px;"><input id="txtOrdeno" type="text" class="txt c1" /></td>
					</tr>
					<tr>
						<td class="td1" style="width: 108px;"><span> </span><a id='lblUmmano' class="lbl">合約編號</a></td>
						<td class="td2" style="width: 108px;"><input id="txtUmmano" type="text" class="txt c1" /></td>
						<td class="td3"><a id='lblTest' class="lbl"><span> </span>耐壓測試</a></td>
						<td class="td4"><input id="textStation" type="text" class="txt c1" /></td>
						<td class="td5"align="right"><input id="btnOrdes" type="button" value="訂單匯入"/></td>
					</tr>
					<tr>
						<td class="td1"><span> </span><a id="lblCust" class="lbl btn">委任廠商</a></td>
					...
					<tr>
						<td class="td1"><span> </span><a id="lblMemoa" class="lbl">備註</a></td>
		...
		<div class='dbbs' style="width: 1400px;">
			<table id="tbbs" class='tbbs'>
				<tr style='color:White; background:#003366;' >
					...
					<td align="center" style="width:95px;">產品編號</td>
					<td align="center" style="width:95px;">產品名稱</td>
					<td align="center" style="width:40px;">規格</td>
					<td align="center" style="width:40px;">重量</td>
					<td align="center" style="width:80px;">合格編號</td>
					<td align="center" style="width:80px;">管身1分鐘</td>
					<td align="center" style="width:80px;">管尾承插口1分鐘</td>
					<td align="center" style="width:80px;">配件</td>
					<td align="center" style="width:40px;">數量</td>
					<td align="center" style="width:80px;">製造商或代號</td>
					<td align="center" style="width:40px;">單重</td>
					<td align="center" style="width:40px;">單位許可差</td>
				</tr>
				<tr style='background:#cad3ff;'>
					...
					<td><input id="txtErrmemo.*" type="text" class="txt num c1"/></td>
					<td><input id="txtQctime.*" type="text" class="txt num c1"/></td>
					<td><input id="txtQcresult.*" type="text" class="txt num c1"/></td>
					<td><input id="txtManu.*" type="text" class="txt num c1"/></td>
					<td><input id="txtMount.*" type="text" class="txt num c1"/></td>
					<td><input id="txtUno.*" type="text" class="txt num c1"/></td>
					<td><input id="txtBweight.*" type="text" class="txt num c1"/></td>
					<td><input id="txtErrmount.*" type="text" class="txt c1"/></td>
				</tr>
			</table>
		</div>
